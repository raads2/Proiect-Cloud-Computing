package com.example.login3.Helpers;
...
public class FavDB extends SQLiteOpenHelper {
    ...
    public ArrayList<SightItem> getAllFavorites() {
        ArrayList<SightItem> favList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String favStatus = cursor.getString(cursor.getColumnIndex(FAVORITE_STATUS));

                favList.add(new SightItem(image, title, id, favStatus));
